...
<body>
	...
	<div class="page-wrapper">
		...
		<div class="content">
			<table style=" margin-top: 90px; border: 1px solid #adbbce box-shadow: 2px 2px 2px #515151; font-size: 20px;">
			<tr>
				<th style="background-color: #bbdeed;">Име:</th>
				<th style="background-color: #bbdeed;">Потребителско име:</th>
				<th style="background-color: #bbdeed;">Teлефон</th>
				<th style="background-color: #bbdeed;">Адрес</th>
				
			</tr>
			<% for(User u : Administrator.getInstance().getAllUsersFromDB()){  %>
				<tr>
					<td style= " height: 70px; color: #04004b; text-align: center; font-size: 18px; background-color: #d3dbe8;"><%= u.getName() %></td>
					<td style= "color: #04004b; text-align: center; font-size: 18px; background-color: #d3dbe8;"><%= u.getUserName() %></td>
					<td style= "color: #04004b; text-align: center; font-size: 18px; background-color: #d3dbe8;"><%= u.getPhoneNumber()%></td>
					<td style= "color: #04004b; text-align: center; font-size: 18px; background-color: #d3dbe8;"><%= u.getAddress() %></td>
				</tr>
			<% }  %>
		</table>
		</div>
